...
Place the `skill-market` directory and its contents in your project root or designated skills directory for Codex, or simply run it from the cloned repository.
